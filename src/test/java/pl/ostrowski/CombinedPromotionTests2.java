...
@SpringBootTest
public class CombinedPromotionTests2 {
	...
	public void contextLoads() {
		// 5*3 (15) + 5*3,99 (19,95) + 5*2,50 (12,5) + 39*2 (78) + 61*2,59 (157,99) + 39*0,79 (30,81) + 7*2,99 (20,93) + 8*5,55 (44.4) = 379,58
		assertTrue("Price not equal", basket.getTotalPrice().compareTo(new BigDecimal("379.58")) == 0);
	}
